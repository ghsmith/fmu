...
public class CaseAttributesFinder {
    ...
    public CaseAttributes getByAccessionNumber(String accessionNumber) throws SQLException {
        ...
        + "   dbo.r_medrec.medrec_num_stripped medrec_num, "
        ...
        + "   dbo.r_pat_demograph.universal_mednum_stripped empi, "
        + "   (select 'Y' from p_special_proc where specimen_id = c_specimen.specimen_id and sprotype_id = 'emy45') cmp26, "
        + "   (select 'Y' from p_special_proc where specimen_id = c_specimen.specimen_id and sprotype_id = 'emy66') mmp75 "
        + " from "
        + "   dbo.c_specimen "
